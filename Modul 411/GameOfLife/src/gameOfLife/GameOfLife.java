...
public class GameOfLife {
	...
	public GameOfLife(int numberOfCellsAtStart) throws InterruptedException {
		createWorld();
		addRandomCells(numberOfCellsAtStart);
	...
	private void printWorld(int worldIndex) {
		for (int i = 0; i < world[0].length; i++) {
			for (int j = 0; j < world[0][0].length; j++) {
				System.out.print(world[worldIndex][i][j]);
			}
			System.out.println();
		}
	}
	...
	private void addRandomCells(int numberOfCellsAtStart) {
